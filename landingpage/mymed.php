...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > MyMedCity Platform Layanan Kesehatan Digital Terintegrasi Modern</title>
<link rel="amphtml" href="https://mymedcity.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> MyMedCity menyediakan platform layanan kesehatan digital yang memudahkan akses informasi medis, konsultasi, manajemen layanan kesehatan, dan pengalaman pasien yang lebih efisien serta terpercaya.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > MyMedCity Platform Layanan Kesehatan Digital Terintegrasi Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> MyMedCity menyediakan platform layanan kesehatan digital yang memudahkan akses informasi medis, konsultasi, manajemen layanan kesehatan, dan pengalaman pasien yang lebih efisien serta terpercaya.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > MyMedCity Platform Layanan Kesehatan Digital Terintegrasi Modern",
      "description": "<?php echo $BRANDS; ?> MyMedCity menyediakan platform layanan kesehatan digital yang memudahkan akses informasi medis, konsultasi, manajemen layanan kesehatan, dan pengalaman pasien yang lebih efisien serta terpercaya.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > MyMedCity Platform Layanan Kesehatan Digital Terintegrasi Modern",
      "description": "<?php echo $BRANDS; ?> MyMedCity menyediakan platform layanan kesehatan digital yang memudahkan akses informasi medis, konsultasi, manajemen layanan kesehatan, dan pengalaman pasien yang lebih efisien serta terpercaya.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > MyMedCity Platform Layanan Kesehatan Digital Terintegrasi Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> MyMedCity menyediakan platform layanan kesehatan digital yang memudahkan akses informasi medis, konsultasi, manajemen layanan kesehatan, dan pengalaman pasien yang lebih efisien serta terpercaya.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://mymedcity.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://mymedcity.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
