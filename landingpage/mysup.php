...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > My Supportive Friend Aplikasi Dukungan Kesehatan Mental Digital</title>
<link rel="amphtml" href="https://mysupportivefriend.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> My Supportive Friend menghadirkan aplikasi yang membantu memberikan dukungan emosional, pengembangan diri, dan kesejahteraan mental melalui fitur digital yang mudah diakses, aman, dan dirancang untuk kebutuhan pengguna.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > My Supportive Friend Aplikasi Dukungan Kesehatan Mental Digital">
<meta property="og:description" content="<?php echo $BRANDS; ?> My Supportive Friend menghadirkan aplikasi yang membantu memberikan dukungan emosional, pengembangan diri, dan kesejahteraan mental melalui fitur digital yang mudah diakses, aman, dan dirancang untuk kebutuhan pengguna.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > My Supportive Friend Aplikasi Dukungan Kesehatan Mental Digital",
      "description": "<?php echo $BRANDS; ?> My Supportive Friend menghadirkan aplikasi yang membantu memberikan dukungan emosional, pengembangan diri, dan kesejahteraan mental melalui fitur digital yang mudah diakses, aman, dan dirancang untuk kebutuhan pengguna.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > My Supportive Friend Aplikasi Dukungan Kesehatan Mental Digital",
      "description": "<?php echo $BRANDS; ?> My Supportive Friend menghadirkan aplikasi yang membantu memberikan dukungan emosional, pengembangan diri, dan kesejahteraan mental melalui fitur digital yang mudah diakses, aman, dan dirancang untuk kebutuhan pengguna.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > My Supportive Friend Aplikasi Dukungan Kesehatan Mental Digital</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> My Supportive Friend menghadirkan aplikasi yang membantu memberikan dukungan emosional, pengembangan diri, dan kesejahteraan mental melalui fitur digital yang mudah diakses, aman, dan dirancang untuk kebutuhan pengguna.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://mysupportivefriend.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://mysupportivefriend.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
