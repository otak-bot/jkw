...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # NeqAPI Online Courses Platform Belajar Teknologi API dan Skill Digital Modern</title>
<link rel="amphtml" href="https://neqa-di4.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> NeqAPI Online Courses menyediakan pembelajaran teknologi API pemrograman dan skill digital modern untuk membantu developer dan profesional meningkatkan kemampuan secara praktis dan fleksibel">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # NeqAPI Online Courses Platform Belajar Teknologi API dan Skill Digital Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> NeqAPI Online Courses menyediakan pembelajaran teknologi API pemrograman dan skill digital modern untuk membantu developer dan profesional meningkatkan kemampuan secara praktis dan fleksibel">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # NeqAPI Online Courses Platform Belajar Teknologi API dan Skill Digital Modern",
      "description": "<?php echo $BRANDS; ?> NeqAPI Online Courses menyediakan pembelajaran teknologi API pemrograman dan skill digital modern untuk membantu developer dan profesional meningkatkan kemampuan secara praktis dan fleksibel",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # NeqAPI Online Courses Platform Belajar Teknologi API dan Skill Digital Modern",
      "description": "<?php echo $BRANDS; ?> NeqAPI Online Courses menyediakan pembelajaran teknologi API pemrograman dan skill digital modern untuk membantu developer dan profesional meningkatkan kemampuan secara praktis dan fleksibel",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # NeqAPI Online Courses Platform Belajar Teknologi API dan Skill Digital Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> NeqAPI Online Courses menyediakan pembelajaran teknologi API pemrograman dan skill digital modern untuk membantu developer dan profesional meningkatkan kemampuan secara praktis dan fleksibel</p>
            </div>
...
<div class="neo-auth">
  <a href="https://neqa-di4.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://neqa-di4.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
