...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Qimat Al Riyf Trading Pemasok Material Konstruksi Berkualitas</title>
<link rel="amphtml" href="https://qimatalriyftrading.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Qimat Al Riyf Trading menyediakan berbagai material konstruksi dan kebutuhan proyek berkualitas untuk sektor bangunan, infrastruktur, dan industri dengan layanan profesional, produk terpercaya, serta pengiriman yang efisien.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Qimat Al Riyf Trading Pemasok Material Konstruksi Berkualitas">
<meta property="og:description" content="<?php echo $BRANDS; ?> Qimat Al Riyf Trading menyediakan berbagai material konstruksi dan kebutuhan proyek berkualitas untuk sektor bangunan, infrastruktur, dan industri dengan layanan profesional, produk terpercaya, serta pengiriman yang efisien.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Qimat Al Riyf Trading Pemasok Material Konstruksi Berkualitas",
      "description": "<?php echo $BRANDS; ?> Qimat Al Riyf Trading menyediakan berbagai material konstruksi dan kebutuhan proyek berkualitas untuk sektor bangunan, infrastruktur, dan industri dengan layanan profesional, produk terpercaya, serta pengiriman yang efisien.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Qimat Al Riyf Trading Pemasok Material Konstruksi Berkualitas",
      "description": "<?php echo $BRANDS; ?> Qimat Al Riyf Trading menyediakan berbagai material konstruksi dan kebutuhan proyek berkualitas untuk sektor bangunan, infrastruktur, dan industri dengan layanan profesional, produk terpercaya, serta pengiriman yang efisien.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Qimat Al Riyf Trading Pemasok Material Konstruksi Berkualitas</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Qimat Al Riyf Trading menyediakan berbagai material konstruksi dan kebutuhan proyek berkualitas untuk sektor bangunan, infrastruktur, dan industri dengan layanan profesional, produk terpercaya, serta pengiriman yang efisien.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://qimatalriyftrading.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://qimatalriyftrading.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
