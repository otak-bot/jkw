...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > DanwanthariDU Layanan Kesehatan Ayurveda Holistik Terpercaya Modern</title>
<link rel="amphtml" href="https://darwan.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> DanwanthariDU menyediakan layanan kesehatan Ayurveda holistik dengan pendekatan alami untuk mendukung keseimbangan tubuh, kesehatan menyeluruh, peningkatan kualitas hidup, dan perawatan berbasis tradisi yang terpercaya.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > DanwanthariDU Layanan Kesehatan Ayurveda Holistik Terpercaya Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> DanwanthariDU menyediakan layanan kesehatan Ayurveda holistik dengan pendekatan alami untuk mendukung keseimbangan tubuh, kesehatan menyeluruh, peningkatan kualitas hidup, dan perawatan berbasis tradisi yang terpercaya.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > DanwanthariDU Layanan Kesehatan Ayurveda Holistik Terpercaya Modern",
      "description": "<?php echo $BRANDS; ?> DanwanthariDU menyediakan layanan kesehatan Ayurveda holistik dengan pendekatan alami untuk mendukung keseimbangan tubuh, kesehatan menyeluruh, peningkatan kualitas hidup, dan perawatan berbasis tradisi yang terpercaya.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > DanwanthariDU Layanan Kesehatan Ayurveda Holistik Terpercaya Modern",
      "description": "<?php echo $BRANDS; ?> DanwanthariDU menyediakan layanan kesehatan Ayurveda holistik dengan pendekatan alami untuk mendukung keseimbangan tubuh, kesehatan menyeluruh, peningkatan kualitas hidup, dan perawatan berbasis tradisi yang terpercaya.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > DanwanthariDU Layanan Kesehatan Ayurveda Holistik Terpercaya Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> DanwanthariDU menyediakan layanan kesehatan Ayurveda holistik dengan pendekatan alami untuk mendukung keseimbangan tubuh, kesehatan menyeluruh, peningkatan kualitas hidup, dan perawatan berbasis tradisi yang terpercaya.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://darwan.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://darwan.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
