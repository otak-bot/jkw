...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > ADTRDCO Supplier Material Bangunan Berkualitas Terpercaya</title>
<link rel="amphtml" href="https://artdco.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> ADTRDCO menyediakan berbagai material bangunan berkualitas untuk proyek konstruksi, renovasi, dan kebutuhan pembangunan dengan layanan profesional terpercaya.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > ADTRDCO Supplier Material Bangunan Berkualitas Terpercaya">
<meta property="og:description" content="<?php echo $BRANDS; ?> ADTRDCO menyediakan berbagai material bangunan berkualitas untuk proyek konstruksi, renovasi, dan kebutuhan pembangunan dengan layanan profesional terpercaya.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > ADTRDCO Supplier Material Bangunan Berkualitas Terpercaya",
      "description": "<?php echo $BRANDS; ?> ADTRDCO menyediakan berbagai material bangunan berkualitas untuk proyek konstruksi, renovasi, dan kebutuhan pembangunan dengan layanan profesional terpercaya.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > ADTRDCO Supplier Material Bangunan Berkualitas Terpercaya",
      "description": "<?php echo $BRANDS; ?> ADTRDCO menyediakan berbagai material bangunan berkualitas untuk proyek konstruksi, renovasi, dan kebutuhan pembangunan dengan layanan profesional terpercaya.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > ADTRDCO Supplier Material Bangunan Berkualitas Terpercaya</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> ADTRDCO menyediakan berbagai material bangunan berkualitas untuk proyek konstruksi, renovasi, dan kebutuhan pembangunan dengan layanan profesional terpercaya.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://artdco.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://artdco.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
