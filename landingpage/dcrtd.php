...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # DCTRD Platform Belajar Marketing dan Skill Digital untuk Tingkatkan Karir Profesional</title>
<link rel="amphtml" href="https://dctrd.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> DCTRD menyediakan kursus marketing dan skill digital dengan pembelajaran praktis langsung dari mentor ahli untuk membantu meningkatkan keahlian kreativitas dan perkembangan karir Anda..">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # DCTRD Platform Belajar Marketing dan Skill Digital untuk Tingkatkan Karir Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> DCTRD menyediakan kursus marketing dan skill digital dengan pembelajaran praktis langsung dari mentor ahli untuk membantu meningkatkan keahlian kreativitas dan perkembangan karir Anda..">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # DCTRD Platform Belajar Marketing dan Skill Digital untuk Tingkatkan Karir Profesional",
      "description": "<?php echo $BRANDS; ?> DCTRD menyediakan kursus marketing dan skill digital dengan pembelajaran praktis langsung dari mentor ahli untuk membantu meningkatkan keahlian kreativitas dan perkembangan karir Anda..",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # DCTRD Platform Belajar Marketing dan Skill Digital untuk Tingkatkan Karir Profesional",
      "description": "<?php echo $BRANDS; ?> DCTRD menyediakan kursus marketing dan skill digital dengan pembelajaran praktis langsung dari mentor ahli untuk membantu meningkatkan keahlian kreativitas dan perkembangan karir Anda..",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # DCTRD Platform Belajar Marketing dan Skill Digital untuk Tingkatkan Karir Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> DCTRD menyediakan kursus marketing dan skill digital dengan pembelajaran praktis langsung dari mentor ahli untuk membantu meningkatkan keahlian kreativitas dan perkembangan karir Anda..</p>
            </div>
...
<div class="neo-auth">
  <a href="https://dctrd.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://dctrd.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
