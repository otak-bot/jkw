...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # WayToSuccess Guru Platform Pengembangan Finansial Karir dan Skill untuk Masa Depan Sukses</title>
<link rel="amphtml" href="https://way2s.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> WayToSuccess Guru membantu Anda meningkatkan finansial karir dan skill melalui pembelajaran praktis tentang penghasilan investasi tabungan dan pengembangan diri untuk masa depan yang lebih sukses.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # WayToSuccess Guru Platform Pengembangan Finansial Karir dan Skill untuk Masa Depan Sukses">
<meta property="og:description" content="<?php echo $BRANDS; ?> WayToSuccess Guru membantu Anda meningkatkan finansial karir dan skill melalui pembelajaran praktis tentang penghasilan investasi tabungan dan pengembangan diri untuk masa depan yang lebih sukses.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # WayToSuccess Guru Platform Pengembangan Finansial Karir dan Skill untuk Masa Depan Sukses",
      "description": "<?php echo $BRANDS; ?> WayToSuccess Guru membantu Anda meningkatkan finansial karir dan skill melalui pembelajaran praktis tentang penghasilan investasi tabungan dan pengembangan diri untuk masa depan yang lebih sukses.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # WayToSuccess Guru Platform Pengembangan Finansial Karir dan Skill untuk Masa Depan Sukses",
      "description": "<?php echo $BRANDS; ?> WayToSuccess Guru membantu Anda meningkatkan finansial karir dan skill melalui pembelajaran praktis tentang penghasilan investasi tabungan dan pengembangan diri untuk masa depan yang lebih sukses.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # WayToSuccess Guru Platform Pengembangan Finansial Karir dan Skill untuk Masa Depan Sukses</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> WayToSuccess Guru membantu Anda meningkatkan finansial karir dan skill melalui pembelajaran praktis tentang penghasilan investasi tabungan dan pengembangan diri untuk masa depan yang lebih sukses.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://way2s.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://way2s.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
