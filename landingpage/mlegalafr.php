...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > MLegal Africa Platform Layanan Hukum Digital Profesional Terintegrasi</title>
<link rel="amphtml" href="https://mlegal-africa.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> MLegal Africa menghadirkan platform layanan hukum digital yang memudahkan pengelolaan dokumen, konsultasi legal, dan proses administrasi hukum secara efisien, aman, serta mendukung kebutuhan individu maupun bisnis.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > MLegal Africa Platform Layanan Hukum Digital Profesional Terintegrasi">
<meta property="og:description" content="<?php echo $BRANDS; ?> MLegal Africa menghadirkan platform layanan hukum digital yang memudahkan pengelolaan dokumen, konsultasi legal, dan proses administrasi hukum secara efisien, aman, serta mendukung kebutuhan individu maupun bisnis.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > MLegal Africa Platform Layanan Hukum Digital Profesional Terintegrasi",
      "description": "<?php echo $BRANDS; ?> MLegal Africa menghadirkan platform layanan hukum digital yang memudahkan pengelolaan dokumen, konsultasi legal, dan proses administrasi hukum secara efisien, aman, serta mendukung kebutuhan individu maupun bisnis.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > MLegal Africa Platform Layanan Hukum Digital Profesional Terintegrasi",
      "description": "<?php echo $BRANDS; ?> MLegal Africa menghadirkan platform layanan hukum digital yang memudahkan pengelolaan dokumen, konsultasi legal, dan proses administrasi hukum secara efisien, aman, serta mendukung kebutuhan individu maupun bisnis.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > MLegal Africa Platform Layanan Hukum Digital Profesional Terintegrasi</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> MLegal Africa menghadirkan platform layanan hukum digital yang memudahkan pengelolaan dokumen, konsultasi legal, dan proses administrasi hukum secara efisien, aman, serta mendukung kebutuhan individu maupun bisnis.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://mlegal-africa.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://mlegal-africa.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
