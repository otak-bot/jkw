...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Masjid Karpet Penyedia Karpet Masjid Berkualitas</title>
<link rel="amphtml" href="https://karpettt.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Masjid Karpet menyediakan karpet masjid berkualitas, nyaman, dan elegan dengan berbagai pilihan desain untuk kebutuhan ibadah yang lebih khusyuk.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Masjid Karpet Penyedia Karpet Masjid Berkualitas">
<meta property="og:description" content="<?php echo $BRANDS; ?> Masjid Karpet menyediakan karpet masjid berkualitas, nyaman, dan elegan dengan berbagai pilihan desain untuk kebutuhan ibadah yang lebih khusyuk.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Masjid Karpet Penyedia Karpet Masjid Berkualitas",
      "description": "<?php echo $BRANDS; ?> Masjid Karpet menyediakan karpet masjid berkualitas, nyaman, dan elegan dengan berbagai pilihan desain untuk kebutuhan ibadah yang lebih khusyuk.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Masjid Karpet Penyedia Karpet Masjid Berkualitas",
      "description": "<?php echo $BRANDS; ?> Masjid Karpet menyediakan karpet masjid berkualitas, nyaman, dan elegan dengan berbagai pilihan desain untuk kebutuhan ibadah yang lebih khusyuk.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Masjid Karpet Penyedia Karpet Masjid Berkualitas</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Masjid Karpet menyediakan karpet masjid berkualitas, nyaman, dan elegan dengan berbagai pilihan desain untuk kebutuhan ibadah yang lebih khusyuk.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://karpettt.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://karpettt.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
