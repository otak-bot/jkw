...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > MedCity LMS Platform Pembelajaran Digital Modern Terintegrasi</title>
<link rel="amphtml" href="https://medcity-c33.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> MedCity LMS menyediakan platform pembelajaran digital yang mendukung manajemen kursus, pelatihan online, evaluasi peserta, dan proses pendidikan yang lebih efektif, terstruktur, serta mudah diakses.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > MedCity LMS Platform Pembelajaran Digital Modern Terintegrasi">
<meta property="og:description" content="<?php echo $BRANDS; ?> MedCity LMS menyediakan platform pembelajaran digital yang mendukung manajemen kursus, pelatihan online, evaluasi peserta, dan proses pendidikan yang lebih efektif, terstruktur, serta mudah diakses.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > MedCity LMS Platform Pembelajaran Digital Modern Terintegrasi",
      "description": "<?php echo $BRANDS; ?> MedCity LMS menyediakan platform pembelajaran digital yang mendukung manajemen kursus, pelatihan online, evaluasi peserta, dan proses pendidikan yang lebih efektif, terstruktur, serta mudah diakses.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > MedCity LMS Platform Pembelajaran Digital Modern Terintegrasi",
      "description": "<?php echo $BRANDS; ?> MedCity LMS menyediakan platform pembelajaran digital yang mendukung manajemen kursus, pelatihan online, evaluasi peserta, dan proses pendidikan yang lebih efektif, terstruktur, serta mudah diakses.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > MedCity LMS Platform Pembelajaran Digital Modern Terintegrasi</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> MedCity LMS menyediakan platform pembelajaran digital yang mendukung manajemen kursus, pelatihan online, evaluasi peserta, dan proses pendidikan yang lebih efektif, terstruktur, serta mudah diakses.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://medcity-c33.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://medcity-c33.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
