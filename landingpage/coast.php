...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Coastal Pliris Solusi Infrastruktur Kelautan Modern</title>
<link rel="amphtml" href="https://coast-129.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Coastal Pliris menyediakan solusi infrastruktur kelautan, layanan teknik profesional, pengembangan pesisir, dan teknologi modern untuk kebutuhan maritim.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Coastal Pliris Solusi Infrastruktur Kelautan Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> Coastal Pliris menyediakan solusi infrastruktur kelautan, layanan teknik profesional, pengembangan pesisir, dan teknologi modern untuk kebutuhan maritim.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Coastal Pliris Solusi Infrastruktur Kelautan Modern",
      "description": "<?php echo $BRANDS; ?> Coastal Pliris menyediakan solusi infrastruktur kelautan, layanan teknik profesional, pengembangan pesisir, dan teknologi modern untuk kebutuhan maritim.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Coastal Pliris Solusi Infrastruktur Kelautan Modern",
      "description": "<?php echo $BRANDS; ?> Coastal Pliris menyediakan solusi infrastruktur kelautan, layanan teknik profesional, pengembangan pesisir, dan teknologi modern untuk kebutuhan maritim.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Coastal Pliris Solusi Infrastruktur Kelautan Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Coastal Pliris menyediakan solusi infrastruktur kelautan, layanan teknik profesional, pengembangan pesisir, dan teknologi modern untuk kebutuhan maritim.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://coast-129.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://coast-129.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
