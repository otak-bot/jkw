...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Linda Beauty Plus Produk Kecantikan Dan Perawatan Premium</title>
<link rel="amphtml" href="https://lindabeauty.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Linda Beauty Plus menyediakan berbagai produk kecantikan, skincare, kosmetik, dan perawatan diri berkualitas untuk membantu menjaga kesehatan kulit, meningkatkan kepercayaan diri, dan menunjang penampilan setiap hari.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Linda Beauty Plus Produk Kecantikan Dan Perawatan Premium">
<meta property="og:description" content="<?php echo $BRANDS; ?> Linda Beauty Plus menyediakan berbagai produk kecantikan, skincare, kosmetik, dan perawatan diri berkualitas untuk membantu menjaga kesehatan kulit, meningkatkan kepercayaan diri, dan menunjang penampilan setiap hari.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Linda Beauty Plus Produk Kecantikan Dan Perawatan Premium",
      "description": "<?php echo $BRANDS; ?> Linda Beauty Plus menyediakan berbagai produk kecantikan, skincare, kosmetik, dan perawatan diri berkualitas untuk membantu menjaga kesehatan kulit, meningkatkan kepercayaan diri, dan menunjang penampilan setiap hari.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Linda Beauty Plus Produk Kecantikan Dan Perawatan Premium",
      "description": "<?php echo $BRANDS; ?> Linda Beauty Plus menyediakan berbagai produk kecantikan, skincare, kosmetik, dan perawatan diri berkualitas untuk membantu menjaga kesehatan kulit, meningkatkan kepercayaan diri, dan menunjang penampilan setiap hari.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Linda Beauty Plus Produk Kecantikan Dan Perawatan Premium</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Linda Beauty Plus menyediakan berbagai produk kecantikan, skincare, kosmetik, dan perawatan diri berkualitas untuk membantu menjaga kesehatan kulit, meningkatkan kepercayaan diri, dan menunjang penampilan setiap hari.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://lindabeauty.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://lindabeauty.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
