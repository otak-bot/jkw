...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # MrMath Pro Platform Belajar Matematika Online untuk Skill dan Prestasi Akademik</title>
<link rel="amphtml" href="https://mrmath.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> MrMath Pro menyediakan pembelajaran matematika online yang interaktif dan mudah dipahami untuk membantu meningkatkan kemampuan berhitung logika dan prestasi akademik siswa.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # MrMath Pro Platform Belajar Matematika Online untuk Skill dan Prestasi Akademik">
<meta property="og:description" content="<?php echo $BRANDS; ?> MrMath Pro menyediakan pembelajaran matematika online yang interaktif dan mudah dipahami untuk membantu meningkatkan kemampuan berhitung logika dan prestasi akademik siswa.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # MrMath Pro Platform Belajar Matematika Online untuk Skill dan Prestasi Akademik",
      "description": "<?php echo $BRANDS; ?> MrMath Pro menyediakan pembelajaran matematika online yang interaktif dan mudah dipahami untuk membantu meningkatkan kemampuan berhitung logika dan prestasi akademik siswa.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # MrMath Pro Platform Belajar Matematika Online untuk Skill dan Prestasi Akademik",
      "description": "<?php echo $BRANDS; ?> MrMath Pro menyediakan pembelajaran matematika online yang interaktif dan mudah dipahami untuk membantu meningkatkan kemampuan berhitung logika dan prestasi akademik siswa.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # MrMath Pro Platform Belajar Matematika Online untuk Skill dan Prestasi Akademik</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> MrMath Pro menyediakan pembelajaran matematika online yang interaktif dan mudah dipahami untuk membantu meningkatkan kemampuan berhitung logika dan prestasi akademik siswa.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://mrmath.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://mrmath.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
