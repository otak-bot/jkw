...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > ShadowMan Solusi Keamanan Siber Dan Teknologi Digital Modern</title>
<link rel="amphtml" href="https://shadowman-e5z.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> ShadowMan menyediakan solusi keamanan siber, layanan teknologi digital, perlindungan sistem, dan konsultasi keamanan IT untuk membantu menjaga data, jaringan, serta infrastruktur bisnis tetap aman dan andal.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > ShadowMan Solusi Keamanan Siber Dan Teknologi Digital Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> ShadowMan menyediakan solusi keamanan siber, layanan teknologi digital, perlindungan sistem, dan konsultasi keamanan IT untuk membantu menjaga data, jaringan, serta infrastruktur bisnis tetap aman dan andal.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > ShadowMan Solusi Keamanan Siber Dan Teknologi Digital Modern",
      "description": "<?php echo $BRANDS; ?> ShadowMan menyediakan solusi keamanan siber, layanan teknologi digital, perlindungan sistem, dan konsultasi keamanan IT untuk membantu menjaga data, jaringan, serta infrastruktur bisnis tetap aman dan andal.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > ShadowMan Solusi Keamanan Siber Dan Teknologi Digital Modern",
      "description": "<?php echo $BRANDS; ?> ShadowMan menyediakan solusi keamanan siber, layanan teknologi digital, perlindungan sistem, dan konsultasi keamanan IT untuk membantu menjaga data, jaringan, serta infrastruktur bisnis tetap aman dan andal.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > ShadowMan Solusi Keamanan Siber Dan Teknologi Digital Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> ShadowMan menyediakan solusi keamanan siber, layanan teknologi digital, perlindungan sistem, dan konsultasi keamanan IT untuk membantu menjaga data, jaringan, serta infrastruktur bisnis tetap aman dan andal.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://shadowman-e5z.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://shadowman-e5z.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
