...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Impex Academy Platform Courses Online untuk Skill Digital Bisnis dan Pengembangan Karir</title>
<link rel="amphtml" href="https://impex-9wi.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Impex Academy menyediakan courses online berkualitas untuk membantu meningkatkan skill digital bisnis dan pengembangan karir dengan pembelajaran modern yang fleksibel dan mudah diakses.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Impex Academy Platform Courses Online untuk Skill Digital Bisnis dan Pengembangan Karir">
<meta property="og:description" content="<?php echo $BRANDS; ?> Impex Academy menyediakan courses online berkualitas untuk membantu meningkatkan skill digital bisnis dan pengembangan karir dengan pembelajaran modern yang fleksibel dan mudah diakses.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Impex Academy Platform Courses Online untuk Skill Digital Bisnis dan Pengembangan Karir",
      "description": "<?php echo $BRANDS; ?> Impex Academy menyediakan courses online berkualitas untuk membantu meningkatkan skill digital bisnis dan pengembangan karir dengan pembelajaran modern yang fleksibel dan mudah diakses.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Impex Academy Platform Courses Online untuk Skill Digital Bisnis dan Pengembangan Karir",
      "description": "<?php echo $BRANDS; ?> Impex Academy menyediakan courses online berkualitas untuk membantu meningkatkan skill digital bisnis dan pengembangan karir dengan pembelajaran modern yang fleksibel dan mudah diakses.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Impex Academy Platform Courses Online untuk Skill Digital Bisnis dan Pengembangan Karir</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Impex Academy menyediakan courses online berkualitas untuk membantu meningkatkan skill digital bisnis dan pengembangan karir dengan pembelajaran modern yang fleksibel dan mudah diakses.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://impex-9wi.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://impex-9wi.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
