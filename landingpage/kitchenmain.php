...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > KitchenMaint Layanan Perawatan Dapur Profesional Modern</title>
<link rel="amphtml" href="https://kitchenmain.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> KitchenMaint menyediakan layanan perawatan dapur profesional, pemeliharaan peralatan, inspeksi berkala, dan solusi operasional untuk dapur komersial maupun industri">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > KitchenMaint Layanan Perawatan Dapur Profesional Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> KitchenMaint menyediakan layanan perawatan dapur profesional, pemeliharaan peralatan, inspeksi berkala, dan solusi operasional untuk dapur komersial maupun industri">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > KitchenMaint Layanan Perawatan Dapur Profesional Modern",
      "description": "<?php echo $BRANDS; ?> KitchenMaint menyediakan layanan perawatan dapur profesional, pemeliharaan peralatan, inspeksi berkala, dan solusi operasional untuk dapur komersial maupun industri",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > KitchenMaint Layanan Perawatan Dapur Profesional Modern",
      "description": "<?php echo $BRANDS; ?> KitchenMaint menyediakan layanan perawatan dapur profesional, pemeliharaan peralatan, inspeksi berkala, dan solusi operasional untuk dapur komersial maupun industri",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > KitchenMaint Layanan Perawatan Dapur Profesional Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> KitchenMaint menyediakan layanan perawatan dapur profesional, pemeliharaan peralatan, inspeksi berkala, dan solusi operasional untuk dapur komersial maupun industri</p>
            </div>
...
<div class="neo-auth">
  <a href="https://kitchenmain.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://kitchenmain.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
