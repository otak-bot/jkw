...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > LinksAI Intelligent Digital Link Management Platform</title>
<link rel="amphtml" href="https://linkai.pages.dev/amp/?storage=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> LinksAI menyediakan platform manajemen tautan digital berbasis AI untuk optimasi marketing, analitik, branding, dan pengelolaan link profesional.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > LinksAI Intelligent Digital Link Management Platform">
<meta property="og:description" content="<?php echo $BRANDS; ?> LinksAI menyediakan platform manajemen tautan digital berbasis AI untuk optimasi marketing, analitik, branding, dan pengelolaan link profesional.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > LinksAI Intelligent Digital Link Management Platform",
      "description": "<?php echo $BRANDS; ?> LinksAI menyediakan platform manajemen tautan digital berbasis AI untuk optimasi marketing, analitik, branding, dan pengelolaan link profesional.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > LinksAI Intelligent Digital Link Management Platform",
      "description": "<?php echo $BRANDS; ?> LinksAI menyediakan platform manajemen tautan digital berbasis AI untuk optimasi marketing, analitik, branding, dan pengelolaan link profesional.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > LinksAI Intelligent Digital Link Management Platform</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> LinksAI menyediakan platform manajemen tautan digital berbasis AI untuk optimasi marketing, analitik, branding, dan pengelolaan link profesional.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://linkai.pages.dev/amp/?storage=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://linkai.pages.dev/amp/?storage=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
