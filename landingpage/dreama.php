...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Dreama Mattresses Kasur Premium Berkualitas untuk Tidur Nyaman dan Istirahat Maksimal</title>
<link rel="amphtml" href="https://dreama-cp5.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Dreama Mattresses menghadirkan kasur premium dengan teknologi modern dan material berkualitas tinggi untuk memberikan tidur lebih nyenyak nyaman dan menyegarkan setiap hari">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Dreama Mattresses Kasur Premium Berkualitas untuk Tidur Nyaman dan Istirahat Maksimal">
<meta property="og:description" content="<?php echo $BRANDS; ?> Dreama Mattresses menghadirkan kasur premium dengan teknologi modern dan material berkualitas tinggi untuk memberikan tidur lebih nyenyak nyaman dan menyegarkan setiap hari">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Dreama Mattresses Kasur Premium Berkualitas untuk Tidur Nyaman dan Istirahat Maksimal",
      "description": "<?php echo $BRANDS; ?> Dreama Mattresses menghadirkan kasur premium dengan teknologi modern dan material berkualitas tinggi untuk memberikan tidur lebih nyenyak nyaman dan menyegarkan setiap hari",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Dreama Mattresses Kasur Premium Berkualitas untuk Tidur Nyaman dan Istirahat Maksimal",
      "description": "<?php echo $BRANDS; ?> Dreama Mattresses menghadirkan kasur premium dengan teknologi modern dan material berkualitas tinggi untuk memberikan tidur lebih nyenyak nyaman dan menyegarkan setiap hari",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Dreama Mattresses Kasur Premium Berkualitas untuk Tidur Nyaman dan Istirahat Maksimal</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Dreama Mattresses menghadirkan kasur premium dengan teknologi modern dan material berkualitas tinggi untuk memberikan tidur lebih nyenyak nyaman dan menyegarkan setiap hari</p>
            </div>
...
<div class="neo-auth">
  <a href="https://dreama-cp5.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://dreama-cp5.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
