...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > NASS Globel Solusi Logistik Dan Perdagangan Internasional</title>
<link rel="amphtml" href="https://naasgloba.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> NASS Globel menyediakan layanan logistik, perdagangan internasional, dan manajemen rantai pasok yang mendukung kelancaran distribusi barang, efisiensi operasional, serta pertumbuhan bisnis di pasar global.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > NASS Globel Solusi Logistik Dan Perdagangan Internasional">
<meta property="og:description" content="<?php echo $BRANDS; ?> NASS Globel menyediakan layanan logistik, perdagangan internasional, dan manajemen rantai pasok yang mendukung kelancaran distribusi barang, efisiensi operasional, serta pertumbuhan bisnis di pasar global.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > NASS Globel Solusi Logistik Dan Perdagangan Internasional",
      "description": "<?php echo $BRANDS; ?> NASS Globel menyediakan layanan logistik, perdagangan internasional, dan manajemen rantai pasok yang mendukung kelancaran distribusi barang, efisiensi operasional, serta pertumbuhan bisnis di pasar global.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > NASS Globel Solusi Logistik Dan Perdagangan Internasional",
      "description": "<?php echo $BRANDS; ?> NASS Globel menyediakan layanan logistik, perdagangan internasional, dan manajemen rantai pasok yang mendukung kelancaran distribusi barang, efisiensi operasional, serta pertumbuhan bisnis di pasar global.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > NASS Globel Solusi Logistik Dan Perdagangan Internasional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> NASS Globel menyediakan layanan logistik, perdagangan internasional, dan manajemen rantai pasok yang mendukung kelancaran distribusi barang, efisiensi operasional, serta pertumbuhan bisnis di pasar global.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://naasgloba.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://naasgloba.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
