...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > iRole Solusi Rekrutmen Digital Dan Manajemen Talenta Profesional</title>
<link rel="amphtml" href="https://irole.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> iRole menyediakan solusi rekrutmen digital, manajemen talenta, dan proses perekrutan yang efisien untuk membantu perusahaan menemukan kandidat terbaik serta mengoptimalkan pengelolaan sumber daya manusia.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > iRole Solusi Rekrutmen Digital Dan Manajemen Talenta Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> iRole menyediakan solusi rekrutmen digital, manajemen talenta, dan proses perekrutan yang efisien untuk membantu perusahaan menemukan kandidat terbaik serta mengoptimalkan pengelolaan sumber daya manusia.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > iRole Solusi Rekrutmen Digital Dan Manajemen Talenta Profesional",
      "description": "<?php echo $BRANDS; ?> iRole menyediakan solusi rekrutmen digital, manajemen talenta, dan proses perekrutan yang efisien untuk membantu perusahaan menemukan kandidat terbaik serta mengoptimalkan pengelolaan sumber daya manusia.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > iRole Solusi Rekrutmen Digital Dan Manajemen Talenta Profesional",
      "description": "<?php echo $BRANDS; ?> iRole menyediakan solusi rekrutmen digital, manajemen talenta, dan proses perekrutan yang efisien untuk membantu perusahaan menemukan kandidat terbaik serta mengoptimalkan pengelolaan sumber daya manusia.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > iRole Solusi Rekrutmen Digital Dan Manajemen Talenta Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> iRole menyediakan solusi rekrutmen digital, manajemen talenta, dan proses perekrutan yang efisien untuk membantu perusahaan menemukan kandidat terbaik serta mengoptimalkan pengelolaan sumber daya manusia.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://irole.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://irole.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
