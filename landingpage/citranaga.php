...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # CitraNagaKencana Solusi Inovatif untuk Transformasi dan Pertumbuhan Bisnis Modern</title>
<link rel="amphtml" href="https://citra-eps.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> CitraNagaKencana menghadirkan solusi inovatif untuk membantu bisnis berkembang lebih cepat dengan teknologi modern strategi digital dan sistem yang siap menghadapi masa depan">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # CitraNagaKencana Solusi Inovatif untuk Transformasi dan Pertumbuhan Bisnis Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> CitraNagaKencana menghadirkan solusi inovatif untuk membantu bisnis berkembang lebih cepat dengan teknologi modern strategi digital dan sistem yang siap menghadapi masa depan">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # CitraNagaKencana Solusi Inovatif untuk Transformasi dan Pertumbuhan Bisnis Modern",
      "description": "<?php echo $BRANDS; ?> CitraNagaKencana menghadirkan solusi inovatif untuk membantu bisnis berkembang lebih cepat dengan teknologi modern strategi digital dan sistem yang siap menghadapi masa depan",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # CitraNagaKencana Solusi Inovatif untuk Transformasi dan Pertumbuhan Bisnis Modern",
      "description": "<?php echo $BRANDS; ?> CitraNagaKencana menghadirkan solusi inovatif untuk membantu bisnis berkembang lebih cepat dengan teknologi modern strategi digital dan sistem yang siap menghadapi masa depan",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # CitraNagaKencana Solusi Inovatif untuk Transformasi dan Pertumbuhan Bisnis Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> CitraNagaKencana menghadirkan solusi inovatif untuk membantu bisnis berkembang lebih cepat dengan teknologi modern strategi digital dan sistem yang siap menghadapi masa depan</p>
            </div>
...
<div class="neo-auth">
  <a href="https://citra-eps.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://citra-eps.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
