...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > PSquare Curtains Gorden Modern Elegan Untuk Berbagai Ruangan</title>
<link rel="amphtml" href="https://curtainsquare.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> PSquare Curtains menyediakan berbagai pilihan gorden modern dengan desain elegan, material berkualitas, serta solusi dekorasi interior untuk hunian, perkantoran, hotel, dan ruang komersial yang mengutamakan estetika, kenyamanan, serta fungsi optimal.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > PSquare Curtains Gorden Modern Elegan Untuk Berbagai Ruangan">
<meta property="og:description" content="<?php echo $BRANDS; ?> PSquare Curtains menyediakan berbagai pilihan gorden modern dengan desain elegan, material berkualitas, serta solusi dekorasi interior untuk hunian, perkantoran, hotel, dan ruang komersial yang mengutamakan estetika, kenyamanan, serta fungsi optimal.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > PSquare Curtains Gorden Modern Elegan Untuk Berbagai Ruangan",
      "description": "<?php echo $BRANDS; ?> PSquare Curtains menyediakan berbagai pilihan gorden modern dengan desain elegan, material berkualitas, serta solusi dekorasi interior untuk hunian, perkantoran, hotel, dan ruang komersial yang mengutamakan estetika, kenyamanan, serta fungsi optimal.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > PSquare Curtains Gorden Modern Elegan Untuk Berbagai Ruangan",
      "description": "<?php echo $BRANDS; ?> PSquare Curtains menyediakan berbagai pilihan gorden modern dengan desain elegan, material berkualitas, serta solusi dekorasi interior untuk hunian, perkantoran, hotel, dan ruang komersial yang mengutamakan estetika, kenyamanan, serta fungsi optimal.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > PSquare Curtains Gorden Modern Elegan Untuk Berbagai Ruangan</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> PSquare Curtains menyediakan berbagai pilihan gorden modern dengan desain elegan, material berkualitas, serta solusi dekorasi interior untuk hunian, perkantoran, hotel, dan ruang komersial yang mengutamakan estetika, kenyamanan, serta fungsi optimal.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://curtainsquare.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://curtainsquare.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
