...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > CPlusAI Platform Teknologi Kecerdasan Buatan Modern</title>
<link rel="amphtml" href="https://cplusai.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> CPlusAI menghadirkan solusi kecerdasan buatan, otomatisasi digital, teknologi AI modern, dan inovasi bisnis untuk kebutuhan industri masa kini.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > CPlusAI Platform Teknologi Kecerdasan Buatan Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> CPlusAI menghadirkan solusi kecerdasan buatan, otomatisasi digital, teknologi AI modern, dan inovasi bisnis untuk kebutuhan industri masa kini.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > CPlusAI Platform Teknologi Kecerdasan Buatan Modern",
      "description": "<?php echo $BRANDS; ?> CPlusAI menghadirkan solusi kecerdasan buatan, otomatisasi digital, teknologi AI modern, dan inovasi bisnis untuk kebutuhan industri masa kini.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > CPlusAI Platform Teknologi Kecerdasan Buatan Modern",
      "description": "<?php echo $BRANDS; ?> CPlusAI menghadirkan solusi kecerdasan buatan, otomatisasi digital, teknologi AI modern, dan inovasi bisnis untuk kebutuhan industri masa kini.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > CPlusAI Platform Teknologi Kecerdasan Buatan Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> CPlusAI menghadirkan solusi kecerdasan buatan, otomatisasi digital, teknologi AI modern, dan inovasi bisnis untuk kebutuhan industri masa kini.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://cplusai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://cplusai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
