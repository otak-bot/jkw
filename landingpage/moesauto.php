...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Moe's Auto Repairs Bengkel Mobil Profesional Dan Terpercaya</title>
<link rel="amphtml" href="https://moesauto.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Moe's Auto Repairs menyediakan layanan servis mobil, perawatan berkala, perbaikan mesin, diagnostik kendaraan, dan perawatan otomotif profesional untuk menjaga performa, keamanan, serta kenyamanan berkendara.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Moe's Auto Repairs Bengkel Mobil Profesional Dan Terpercaya">
<meta property="og:description" content="<?php echo $BRANDS; ?> Moe's Auto Repairs menyediakan layanan servis mobil, perawatan berkala, perbaikan mesin, diagnostik kendaraan, dan perawatan otomotif profesional untuk menjaga performa, keamanan, serta kenyamanan berkendara.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Moe's Auto Repairs Bengkel Mobil Profesional Dan Terpercaya",
      "description": "<?php echo $BRANDS; ?> Moe's Auto Repairs menyediakan layanan servis mobil, perawatan berkala, perbaikan mesin, diagnostik kendaraan, dan perawatan otomotif profesional untuk menjaga performa, keamanan, serta kenyamanan berkendara.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Moe's Auto Repairs Bengkel Mobil Profesional Dan Terpercaya",
      "description": "<?php echo $BRANDS; ?> Moe's Auto Repairs menyediakan layanan servis mobil, perawatan berkala, perbaikan mesin, diagnostik kendaraan, dan perawatan otomotif profesional untuk menjaga performa, keamanan, serta kenyamanan berkendara.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Moe's Auto Repairs Bengkel Mobil Profesional Dan Terpercaya</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Moe's Auto Repairs menyediakan layanan servis mobil, perawatan berkala, perbaikan mesin, diagnostik kendaraan, dan perawatan otomotif profesional untuk menjaga performa, keamanan, serta kenyamanan berkendara.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://moesauto.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://moesauto.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
