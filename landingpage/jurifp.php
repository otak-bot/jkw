...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Juri Food Produk Makanan Berkualitas Dan Distribusi Profesional</title>
<link rel="amphtml" href="https://jurifoodco.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Juri Food menyediakan berbagai produk makanan berkualitas dengan standar produksi yang terjaga, layanan distribusi profesional, serta komitmen menghadirkan cita rasa terbaik untuk kebutuhan konsumen maupun bisnis.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Juri Food Produk Makanan Berkualitas Dan Distribusi Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> Juri Food menyediakan berbagai produk makanan berkualitas dengan standar produksi yang terjaga, layanan distribusi profesional, serta komitmen menghadirkan cita rasa terbaik untuk kebutuhan konsumen maupun bisnis.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Juri Food Produk Makanan Berkualitas Dan Distribusi Profesional",
      "description": "<?php echo $BRANDS; ?> Juri Food menyediakan berbagai produk makanan berkualitas dengan standar produksi yang terjaga, layanan distribusi profesional, serta komitmen menghadirkan cita rasa terbaik untuk kebutuhan konsumen maupun bisnis.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Juri Food Produk Makanan Berkualitas Dan Distribusi Profesional",
      "description": "<?php echo $BRANDS; ?> Juri Food menyediakan berbagai produk makanan berkualitas dengan standar produksi yang terjaga, layanan distribusi profesional, serta komitmen menghadirkan cita rasa terbaik untuk kebutuhan konsumen maupun bisnis.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Juri Food Produk Makanan Berkualitas Dan Distribusi Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Juri Food menyediakan berbagai produk makanan berkualitas dengan standar produksi yang terjaga, layanan distribusi profesional, serta komitmen menghadirkan cita rasa terbaik untuk kebutuhan konsumen maupun bisnis.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://jurifoodco.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://jurifoodco.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
