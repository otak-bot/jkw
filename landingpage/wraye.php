...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Wrayee Deliveries Layanan Pengiriman Cepat Dan Logistik Profesional</title>
<link rel="amphtml" href="https://wrayedeliv.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Wrayee Deliveries menyediakan layanan pengiriman barang, logistik, dan distribusi yang cepat, aman, serta terpercaya untuk memenuhi kebutuhan individu maupun bisnis dengan proses yang efisien dan tepat waktu.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Wrayee Deliveries Layanan Pengiriman Cepat Dan Logistik Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> Wrayee Deliveries menyediakan layanan pengiriman barang, logistik, dan distribusi yang cepat, aman, serta terpercaya untuk memenuhi kebutuhan individu maupun bisnis dengan proses yang efisien dan tepat waktu.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Wrayee Deliveries Layanan Pengiriman Cepat Dan Logistik Profesional",
      "description": "<?php echo $BRANDS; ?> Wrayee Deliveries menyediakan layanan pengiriman barang, logistik, dan distribusi yang cepat, aman, serta terpercaya untuk memenuhi kebutuhan individu maupun bisnis dengan proses yang efisien dan tepat waktu.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Wrayee Deliveries Layanan Pengiriman Cepat Dan Logistik Profesional",
      "description": "<?php echo $BRANDS; ?> Wrayee Deliveries menyediakan layanan pengiriman barang, logistik, dan distribusi yang cepat, aman, serta terpercaya untuk memenuhi kebutuhan individu maupun bisnis dengan proses yang efisien dan tepat waktu.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Wrayee Deliveries Layanan Pengiriman Cepat Dan Logistik Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Wrayee Deliveries menyediakan layanan pengiriman barang, logistik, dan distribusi yang cepat, aman, serta terpercaya untuk memenuhi kebutuhan individu maupun bisnis dengan proses yang efisien dan tepat waktu.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://wrayedeliv.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://wrayedeliv.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
