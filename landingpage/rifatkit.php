...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Rifat Kitchen Peralatan Dapur Modern Berkualitas</title>
<link rel="amphtml" href="https://rifatkit.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Rifat Kitchen menyediakan berbagai peralatan dapur modern berkualitas, perlengkapan memasak, dan kebutuhan rumah tangga untuk pengalaman memasak yang lebih praktis.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Rifat Kitchen Peralatan Dapur Modern Berkualitas">
<meta property="og:description" content="<?php echo $BRANDS; ?> Rifat Kitchen menyediakan berbagai peralatan dapur modern berkualitas, perlengkapan memasak, dan kebutuhan rumah tangga untuk pengalaman memasak yang lebih praktis.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Rifat Kitchen Peralatan Dapur Modern Berkualitas",
      "description": "<?php echo $BRANDS; ?> Rifat Kitchen menyediakan berbagai peralatan dapur modern berkualitas, perlengkapan memasak, dan kebutuhan rumah tangga untuk pengalaman memasak yang lebih praktis.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Rifat Kitchen Peralatan Dapur Modern Berkualitas",
      "description": "<?php echo $BRANDS; ?> Rifat Kitchen menyediakan berbagai peralatan dapur modern berkualitas, perlengkapan memasak, dan kebutuhan rumah tangga untuk pengalaman memasak yang lebih praktis.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Rifat Kitchen Peralatan Dapur Modern Berkualitas</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Rifat Kitchen menyediakan berbagai peralatan dapur modern berkualitas, perlengkapan memasak, dan kebutuhan rumah tangga untuk pengalaman memasak yang lebih praktis.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://rifatkit.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://rifatkit.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
