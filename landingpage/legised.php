...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Legis Education Abroad Konsultan Studi Luar Negeri Profesional</title>
<link rel="amphtml" href="https://legiseducationabroad.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Legis Education Abroad menyediakan layanan konsultasi studi luar negeri, bimbingan pemilihan universitas, bantuan proses pendaftaran, dan pendampingan visa untuk membantu mewujudkan pendidikan internasional yang berkualitas.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Legis Education Abroad Konsultan Studi Luar Negeri Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> Legis Education Abroad menyediakan layanan konsultasi studi luar negeri, bimbingan pemilihan universitas, bantuan proses pendaftaran, dan pendampingan visa untuk membantu mewujudkan pendidikan internasional yang berkualitas.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Legis Education Abroad Konsultan Studi Luar Negeri Profesional",
      "description": "<?php echo $BRANDS; ?> Legis Education Abroad menyediakan layanan konsultasi studi luar negeri, bimbingan pemilihan universitas, bantuan proses pendaftaran, dan pendampingan visa untuk membantu mewujudkan pendidikan internasional yang berkualitas.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Legis Education Abroad Konsultan Studi Luar Negeri Profesional",
      "description": "<?php echo $BRANDS; ?> Legis Education Abroad menyediakan layanan konsultasi studi luar negeri, bimbingan pemilihan universitas, bantuan proses pendaftaran, dan pendampingan visa untuk membantu mewujudkan pendidikan internasional yang berkualitas.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Legis Education Abroad Konsultan Studi Luar Negeri Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Legis Education Abroad menyediakan layanan konsultasi studi luar negeri, bimbingan pemilihan universitas, bantuan proses pendaftaran, dan pendampingan visa untuk membantu mewujudkan pendidikan internasional yang berkualitas.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://legiseducationabroad.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://legiseducationabroad.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
