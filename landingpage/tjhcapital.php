...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > TJH Capital Solusi Investasi Keuangan Profesional</title>
<link rel="amphtml" href="https://tjhcapital.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> TJH Capital menyediakan layanan investasi dan konsultasi keuangan profesional untuk membantu pertumbuhan aset, perencanaan finansial, dan strategi bisnis berkelanjutan.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > TJH Capital Solusi Investasi Keuangan Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> TJH Capital menyediakan layanan investasi dan konsultasi keuangan profesional untuk membantu pertumbuhan aset, perencanaan finansial, dan strategi bisnis berkelanjutan.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > TJH Capital Solusi Investasi Keuangan Profesional",
      "description": "<?php echo $BRANDS; ?> TJH Capital menyediakan layanan investasi dan konsultasi keuangan profesional untuk membantu pertumbuhan aset, perencanaan finansial, dan strategi bisnis berkelanjutan.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > TJH Capital Solusi Investasi Keuangan Profesional",
      "description": "<?php echo $BRANDS; ?> TJH Capital menyediakan layanan investasi dan konsultasi keuangan profesional untuk membantu pertumbuhan aset, perencanaan finansial, dan strategi bisnis berkelanjutan.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > TJH Capital Solusi Investasi Keuangan Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> TJH Capital menyediakan layanan investasi dan konsultasi keuangan profesional untuk membantu pertumbuhan aset, perencanaan finansial, dan strategi bisnis berkelanjutan.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://tjhcapital.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://tjhcapital.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
