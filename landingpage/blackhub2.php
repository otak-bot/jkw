...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > BlackCodeHub Advanced Software Development Technology Platform</title>
<link rel="amphtml" href="https://blcode.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> BlackCodeHub menyediakan layanan pengembangan software, solusi teknologi modern, programming profesional, dan inovasi digital untuk kebutuhan bisnis global.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > BlackCodeHub Advanced Software Development Technology Platform">
<meta property="og:description" content="<?php echo $BRANDS; ?> BlackCodeHub menyediakan layanan pengembangan software, solusi teknologi modern, programming profesional, dan inovasi digital untuk kebutuhan bisnis global.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > BlackCodeHub Advanced Software Development Technology Platform",
      "description": "<?php echo $BRANDS; ?> BlackCodeHub menyediakan layanan pengembangan software, solusi teknologi modern, programming profesional, dan inovasi digital untuk kebutuhan bisnis global.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > BlackCodeHub Advanced Software Development Technology Platform",
      "description": "<?php echo $BRANDS; ?> BlackCodeHub menyediakan layanan pengembangan software, solusi teknologi modern, programming profesional, dan inovasi digital untuk kebutuhan bisnis global.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > BlackCodeHub Advanced Software Development Technology Platform</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> BlackCodeHub menyediakan layanan pengembangan software, solusi teknologi modern, programming profesional, dan inovasi digital untuk kebutuhan bisnis global.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://blcode.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://blcode.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
