...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > KyuBox Solusi Penyimpanan Dan Manajemen Data Digital Modern</title>
<link rel="amphtml" href="https://kyubox.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> KyuBox menyediakan solusi penyimpanan, pengelolaan data, dan layanan digital yang membantu individu maupun bisnis mengelola informasi secara aman, efisien, serta mudah diakses melalui teknologi modern.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > KyuBox Solusi Penyimpanan Dan Manajemen Data Digital Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> KyuBox menyediakan solusi penyimpanan, pengelolaan data, dan layanan digital yang membantu individu maupun bisnis mengelola informasi secara aman, efisien, serta mudah diakses melalui teknologi modern.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > KyuBox Solusi Penyimpanan Dan Manajemen Data Digital Modern",
      "description": "<?php echo $BRANDS; ?> KyuBox menyediakan solusi penyimpanan, pengelolaan data, dan layanan digital yang membantu individu maupun bisnis mengelola informasi secara aman, efisien, serta mudah diakses melalui teknologi modern.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > KyuBox Solusi Penyimpanan Dan Manajemen Data Digital Modern",
      "description": "<?php echo $BRANDS; ?> KyuBox menyediakan solusi penyimpanan, pengelolaan data, dan layanan digital yang membantu individu maupun bisnis mengelola informasi secara aman, efisien, serta mudah diakses melalui teknologi modern.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > KyuBox Solusi Penyimpanan Dan Manajemen Data Digital Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> KyuBox menyediakan solusi penyimpanan, pengelolaan data, dan layanan digital yang membantu individu maupun bisnis mengelola informasi secara aman, efisien, serta mudah diakses melalui teknologi modern.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://kyubox.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://kyubox.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
