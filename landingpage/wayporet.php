...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Waypoint Retail Solusi Manajemen Ritel Modern Terintegrasi Profesional</title>
<link rel="amphtml" href="https://waypointretail.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Waypoint Retail menyediakan solusi manajemen ritel modern yang membantu mengelola operasional toko, inventaris, penjualan, dan proses bisnis secara efisien melalui teknologi yang terintegrasi dan mudah digunakan.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Waypoint Retail Solusi Manajemen Ritel Modern Terintegrasi Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> Waypoint Retail menyediakan solusi manajemen ritel modern yang membantu mengelola operasional toko, inventaris, penjualan, dan proses bisnis secara efisien melalui teknologi yang terintegrasi dan mudah digunakan.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Waypoint Retail Solusi Manajemen Ritel Modern Terintegrasi Profesional",
      "description": "<?php echo $BRANDS; ?> Waypoint Retail menyediakan solusi manajemen ritel modern yang membantu mengelola operasional toko, inventaris, penjualan, dan proses bisnis secara efisien melalui teknologi yang terintegrasi dan mudah digunakan.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Waypoint Retail Solusi Manajemen Ritel Modern Terintegrasi Profesional",
      "description": "<?php echo $BRANDS; ?> Waypoint Retail menyediakan solusi manajemen ritel modern yang membantu mengelola operasional toko, inventaris, penjualan, dan proses bisnis secara efisien melalui teknologi yang terintegrasi dan mudah digunakan.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Waypoint Retail Solusi Manajemen Ritel Modern Terintegrasi Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Waypoint Retail menyediakan solusi manajemen ritel modern yang membantu mengelola operasional toko, inventaris, penjualan, dan proses bisnis secara efisien melalui teknologi yang terintegrasi dan mudah digunakan.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://waypointretail.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://waypointretail.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
