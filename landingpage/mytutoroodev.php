...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > MyTutorRoom Platform Bimbingan Belajar Online Profesional Terpercaya</title>
<link rel="amphtml" href="https://mytutorroo.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> MyTutorRoom menyediakan platform bimbingan belajar online dengan tutor berpengalaman, kelas interaktif, materi berkualitas, dan metode pembelajaran yang dirancang untuk membantu meningkatkan prestasi akademik siswa.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > MyTutorRoom Platform Bimbingan Belajar Online Profesional Terpercaya">
<meta property="og:description" content="<?php echo $BRANDS; ?> MyTutorRoom menyediakan platform bimbingan belajar online dengan tutor berpengalaman, kelas interaktif, materi berkualitas, dan metode pembelajaran yang dirancang untuk membantu meningkatkan prestasi akademik siswa.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > MyTutorRoom Platform Bimbingan Belajar Online Profesional Terpercaya",
      "description": "<?php echo $BRANDS; ?> MyTutorRoom menyediakan platform bimbingan belajar online dengan tutor berpengalaman, kelas interaktif, materi berkualitas, dan metode pembelajaran yang dirancang untuk membantu meningkatkan prestasi akademik siswa.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > MyTutorRoom Platform Bimbingan Belajar Online Profesional Terpercaya",
      "description": "<?php echo $BRANDS; ?> MyTutorRoom menyediakan platform bimbingan belajar online dengan tutor berpengalaman, kelas interaktif, materi berkualitas, dan metode pembelajaran yang dirancang untuk membantu meningkatkan prestasi akademik siswa.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > MyTutorRoom Platform Bimbingan Belajar Online Profesional Terpercaya</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> MyTutorRoom menyediakan platform bimbingan belajar online dengan tutor berpengalaman, kelas interaktif, materi berkualitas, dan metode pembelajaran yang dirancang untuk membantu meningkatkan prestasi akademik siswa.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://mytutorroo.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://mytutorroo.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
