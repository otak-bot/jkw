...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Caratai Advanced Artificial Intelligence Technology Solutions</title>
<link rel="amphtml" href="https://caratai.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Caratai menghadirkan solusi artificial intelligence, teknologi modern, otomatisasi digital, dan inovasi AI untuk mendukung perkembangan bisnis dan industri.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Caratai Advanced Artificial Intelligence Technology Solutions">
<meta property="og:description" content="<?php echo $BRANDS; ?> Caratai menghadirkan solusi artificial intelligence, teknologi modern, otomatisasi digital, dan inovasi AI untuk mendukung perkembangan bisnis dan industri.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Caratai Advanced Artificial Intelligence Technology Solutions",
      "description": "<?php echo $BRANDS; ?> Caratai menghadirkan solusi artificial intelligence, teknologi modern, otomatisasi digital, dan inovasi AI untuk mendukung perkembangan bisnis dan industri.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Caratai Advanced Artificial Intelligence Technology Solutions",
      "description": "<?php echo $BRANDS; ?> Caratai menghadirkan solusi artificial intelligence, teknologi modern, otomatisasi digital, dan inovasi AI untuk mendukung perkembangan bisnis dan industri.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Caratai Advanced Artificial Intelligence Technology Solutions</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Caratai menghadirkan solusi artificial intelligence, teknologi modern, otomatisasi digital, dan inovasi AI untuk mendukung perkembangan bisnis dan industri.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://caratai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://caratai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
