...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Zuckero Platform Solusi Digital Dan Teknologi Modern Terintegrasi</title>
<link rel="amphtml" href="https://zuckero.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Zuckero menghadirkan solusi digital dan teknologi inovatif untuk mendukung transformasi bisnis, pengembangan sistem, serta peningkatan efisiensi operasional melalui layanan profesional yang modern dan terpercaya.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Zuckero Platform Solusi Digital Dan Teknologi Modern Terintegrasi">
<meta property="og:description" content="<?php echo $BRANDS; ?> Zuckero menghadirkan solusi digital dan teknologi inovatif untuk mendukung transformasi bisnis, pengembangan sistem, serta peningkatan efisiensi operasional melalui layanan profesional yang modern dan terpercaya.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Zuckero Platform Solusi Digital Dan Teknologi Modern Terintegrasi",
      "description": "<?php echo $BRANDS; ?> Zuckero menghadirkan solusi digital dan teknologi inovatif untuk mendukung transformasi bisnis, pengembangan sistem, serta peningkatan efisiensi operasional melalui layanan profesional yang modern dan terpercaya.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Zuckero Platform Solusi Digital Dan Teknologi Modern Terintegrasi",
      "description": "<?php echo $BRANDS; ?> Zuckero menghadirkan solusi digital dan teknologi inovatif untuk mendukung transformasi bisnis, pengembangan sistem, serta peningkatan efisiensi operasional melalui layanan profesional yang modern dan terpercaya.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Zuckero Platform Solusi Digital Dan Teknologi Modern Terintegrasi</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Zuckero menghadirkan solusi digital dan teknologi inovatif untuk mendukung transformasi bisnis, pengembangan sistem, serta peningkatan efisiensi operasional melalui layanan profesional yang modern dan terpercaya.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://zuckero.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://zuckero.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
