...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > Today's Trending Portal Berita Dan Informasi Terkini Digital</title>
<link rel="amphtml" href="https://todaystrending.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Today's Trending menyajikan berita, informasi, dan topik yang sedang populer dari berbagai kategori untuk membantu pembaca mendapatkan wawasan terbaru, terpercaya, dan mudah diakses setiap hari.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > Today's Trending Portal Berita Dan Informasi Terkini Digital">
<meta property="og:description" content="<?php echo $BRANDS; ?> Today's Trending menyajikan berita, informasi, dan topik yang sedang populer dari berbagai kategori untuk membantu pembaca mendapatkan wawasan terbaru, terpercaya, dan mudah diakses setiap hari.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > Today's Trending Portal Berita Dan Informasi Terkini Digital",
      "description": "<?php echo $BRANDS; ?> Today's Trending menyajikan berita, informasi, dan topik yang sedang populer dari berbagai kategori untuk membantu pembaca mendapatkan wawasan terbaru, terpercaya, dan mudah diakses setiap hari.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > Today's Trending Portal Berita Dan Informasi Terkini Digital",
      "description": "<?php echo $BRANDS; ?> Today's Trending menyajikan berita, informasi, dan topik yang sedang populer dari berbagai kategori untuk membantu pembaca mendapatkan wawasan terbaru, terpercaya, dan mudah diakses setiap hari.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > Today's Trending Portal Berita Dan Informasi Terkini Digital</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Today's Trending menyajikan berita, informasi, dan topik yang sedang populer dari berbagai kategori untuk membantu pembaca mendapatkan wawasan terbaru, terpercaya, dan mudah diakses setiap hari.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://todaystrending.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://todaystrending.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
