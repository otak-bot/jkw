...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> > InStyle Creation Desain Interior Modern Elegan Profesional</title>
<link rel="amphtml" href="https://instylecre.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> InStyle Creation menyediakan layanan desain interior modern dan elegan untuk hunian, perkantoran, serta ruang komersial dengan konsep kreatif, pengerjaan profesional, dan hasil yang fungsional serta berkelas.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> > InStyle Creation Desain Interior Modern Elegan Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> InStyle Creation menyediakan layanan desain interior modern dan elegan untuk hunian, perkantoran, serta ruang komersial dengan konsep kreatif, pengerjaan profesional, dan hasil yang fungsional serta berkelas.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> > InStyle Creation Desain Interior Modern Elegan Profesional",
      "description": "<?php echo $BRANDS; ?> InStyle Creation menyediakan layanan desain interior modern dan elegan untuk hunian, perkantoran, serta ruang komersial dengan konsep kreatif, pengerjaan profesional, dan hasil yang fungsional serta berkelas.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> > InStyle Creation Desain Interior Modern Elegan Profesional",
      "description": "<?php echo $BRANDS; ?> InStyle Creation menyediakan layanan desain interior modern dan elegan untuk hunian, perkantoran, serta ruang komersial dengan konsep kreatif, pengerjaan profesional, dan hasil yang fungsional serta berkelas.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> > InStyle Creation Desain Interior Modern Elegan Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> InStyle Creation menyediakan layanan desain interior modern dan elegan untuk hunian, perkantoran, serta ruang komersial dengan konsep kreatif, pengerjaan profesional, dan hasil yang fungsional serta berkelas.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://instylecre.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://instylecre.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
