...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # RavenStudio Jasa Broadcast dan Event Organizer Profesional di Indonesia</title>
<link rel="amphtml" href="https://raven-827.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> RavenStudio menyediakan layanan broadcast dan event organizer profesional di Indonesia untuk acara perusahaan konser webinar live streaming dan berbagai event berkualitas tinggi">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # RavenStudio Jasa Broadcast dan Event Organizer Profesional di Indonesia">
<meta property="og:description" content="<?php echo $BRANDS; ?> RavenStudio menyediakan layanan broadcast dan event organizer profesional di Indonesia untuk acara perusahaan konser webinar live streaming dan berbagai event berkualitas tinggi">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # RavenStudio Jasa Broadcast dan Event Organizer Profesional di Indonesia",
      "description": "<?php echo $BRANDS; ?> RavenStudio menyediakan layanan broadcast dan event organizer profesional di Indonesia untuk acara perusahaan konser webinar live streaming dan berbagai event berkualitas tinggi",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # RavenStudio Jasa Broadcast dan Event Organizer Profesional di Indonesia",
      "description": "<?php echo $BRANDS; ?> RavenStudio menyediakan layanan broadcast dan event organizer profesional di Indonesia untuk acara perusahaan konser webinar live streaming dan berbagai event berkualitas tinggi",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # RavenStudio Jasa Broadcast dan Event Organizer Profesional di Indonesia</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> RavenStudio menyediakan layanan broadcast dan event organizer profesional di Indonesia untuk acara perusahaan konser webinar live streaming dan berbagai event berkualitas tinggi</p>
            </div>
...
<div class="neo-auth">
  <a href="https://raven-827.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://raven-827.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
