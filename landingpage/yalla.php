...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # YallaEdu Platform Pembelajaran Online Modern untuk Skill Pendidikan dan Pengembangan Karir</title>
<link rel="amphtml" href="https://yalla-6ug.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> YallaEdu menyediakan platform pembelajaran online modern dengan berbagai kursus dan materi edukasi untuk membantu meningkatkan skill pendidikan dan perkembangan karir Anda.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # YallaEdu Platform Pembelajaran Online Modern untuk Skill Pendidikan dan Pengembangan Karir">
<meta property="og:description" content="<?php echo $BRANDS; ?> YallaEdu menyediakan platform pembelajaran online modern dengan berbagai kursus dan materi edukasi untuk membantu meningkatkan skill pendidikan dan perkembangan karir Anda.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # YallaEdu Platform Pembelajaran Online Modern untuk Skill Pendidikan dan Pengembangan Karir",
      "description": "<?php echo $BRANDS; ?> YallaEdu menyediakan platform pembelajaran online modern dengan berbagai kursus dan materi edukasi untuk membantu meningkatkan skill pendidikan dan perkembangan karir Anda.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # YallaEdu Platform Pembelajaran Online Modern untuk Skill Pendidikan dan Pengembangan Karir",
      "description": "<?php echo $BRANDS; ?> YallaEdu menyediakan platform pembelajaran online modern dengan berbagai kursus dan materi edukasi untuk membantu meningkatkan skill pendidikan dan perkembangan karir Anda.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # YallaEdu Platform Pembelajaran Online Modern untuk Skill Pendidikan dan Pengembangan Karir</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> YallaEdu menyediakan platform pembelajaran online modern dengan berbagai kursus dan materi edukasi untuk membantu meningkatkan skill pendidikan dan perkembangan karir Anda.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://yalla-6ug.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://yalla-6ug.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
